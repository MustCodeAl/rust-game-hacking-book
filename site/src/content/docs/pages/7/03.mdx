...
description: "Learn PE32 and PE32+ data directories, RVAs, section mappings, export names, ordinals, address entries, and forwarded exports with a bounded parser."
chapter: "7.3"
minutes: 42
author: "attilathedud"
date: "2026-08-04"
sidebar:
  order: 3
  label: "7.3 Parse a DLL's Export Table Safely"
---
...
<MemoryStrip
  ...
  marks="3-9"
  groups="0-2:skipped|3-9:read by `parse_export_table`"
...
The complete parser is [`export_inspector.rs`](/windows-labs/src/bin/export_inspector.rs).
