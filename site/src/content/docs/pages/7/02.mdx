...
description: "Translate among PE file offsets, RVAs, preferred addresses, and live addresses with checked section and ASLR calculations."
chapter: "7.2"
minutes: 28
author: "attilathedud"
date: "2026-07-30"
sidebar:
  order: 2
  label: "7.2 Turn RVAs into Live Game Addresses"
---
...
The buildable tool is [`module_inspector.rs`](/windows-labs/src/bin/module_inspector.rs), and its ToolHelp implementation is in [`process.rs`](/windows-labs/src/windows_impl/process.rs).
