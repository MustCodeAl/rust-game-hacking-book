...
description: "Locate a save with Process Monitor, compare controlled snapshots, and write changes atomically."
chapter: "9.2"
minutes: 17
author: "attilathedud"
date: "2026-07-30"
sidebar:
  order: 2
  label: "9.2 Find and Edit Save Data Safely"
---
...
Writing directly truncates the original before the new
...
character, and later saves it normally. That final save matters because the game
wrote it: if the edited value is still there, the change survived the game's own
loader and serializer.

The complete program is [`flare_save_editor.rs`](/windows-labs/src/bin/flare_save_editor.rs); the reusable Windows replacement boundary is [`file_replace.rs`](/windows-labs/src/windows_impl/file_replace.rs).
