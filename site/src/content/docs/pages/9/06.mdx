...
description: "Record every installed file, original hash, replacement hash, and restore action so a game mod can be audited and removed cleanly."
chapter: "9.6"
minutes: 24
author: "attilathedud"
date: "2026-08-14"
sidebar:
  order: 6
  label: "9.6 Build a Reversible Mod Manifest"
---
...
An installer can crash after making a backup but before copying the replacement. The installer's manifest stores the transaction in recoverable stages:
