...
description: "Build a Turing machine by hand, see why one computer can run every program, and learn which questions about programs no tool can always answer."
chapter: "1.11"
minutes: 22
author: "attilathedud"
date: "2026-09-24"
sidebar:
  order: 11
  label: "1.11 What Any Computer Can Compute"
---
...
happen on that input. That is why the lessons pair reading code with running
it.

## Run the machine yourself

The portable lab [`turing_machine_lab.rs`](/rust-labs/src/bin/turing_machine_lab.rs)
