...
description: "Follow the stages that turn source code into an EXE and then into a process, and see why field names disappear, why offsets are fixed for one build, and why imports are filled in last."
chapter: "1.9"
minutes: 20
author: "attilathedud"
date: "2026-09-08"
sidebar:
  order: 9
  label: "1.9 From Source Code to a Running Program"
---
...
| What you found | Survives a rebuild? | Why |
|---|---|---|
