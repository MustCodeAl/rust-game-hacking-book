...
description: "Parse a PE32 import table, redirect one MessageBoxW call inside the lab process, and restore the original pointer automatically."
chapter: "8.4"
minutes: 28
author: "attilathedud"
date: "2026-07-30"
sidebar:
  order: 4
  label: "8.4 Hook Your Own Import Table"
---
