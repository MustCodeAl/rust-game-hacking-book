...
description: "Reuse the print function you already located to draw a menu inside the game, and handle the cursor wrapping, key edges, and string lifetimes that make it work."
chapter: "8.9"
minutes: 26
author: "attilathedud"
date: "2026-09-08"
sidebar:
  order: 9
  label: "8.9 Draw a Menu with the Game's Own Text Function"
---
...
itself in [Lesson 5.3](/pages/5/03/#keep-the-original-function). Every nested
