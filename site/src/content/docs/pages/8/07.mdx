...
description: "Build a readable egui settings menu, model feature state with enums, send commands to a worker, and clean up safely."
chapter: "8.7"
minutes: 38
author: "attilathedud"
date: "2026-08-14"
sidebar:
  order: 7
  label: "8.7 Build a Menu for Your Local Tool"
---
...
[`menu_lab.rs`](/windows-labs/src/bin/menu_lab.rs). It uses
...
- group read-only, overlay, and input features separately;
