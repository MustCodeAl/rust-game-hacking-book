...
description: "Reproduce eight recurring control failures against a runnable toy lab, then move each invariant to the boundary where the effect actually happens."
chapter: "13.9"
minutes: 55
author: "attilathedud"
date: "2026-09-03"
sidebar:
  order: 9
  label: "13.9 Eight More Bypass Patterns and Their Repairs"
---
## Prerequisites
...
[`bypass_patterns_lab.rs`](/rust-labs/src/bin/bypass_patterns_lab.rs),
...
## Place a bypass claim in the table
...
| What shows the gap in practice? | a decision that contradicts the promise |
...
- **Freshness:** the property that a message has not been used before, which
