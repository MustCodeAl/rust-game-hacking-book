...
description: "Turn a vague game-analysis question into an explicit state model, a falsifiable hypothesis, and evidence another person can reproduce."
chapter: "13.1"
minutes: 42
author: "attilathedud"
date: "2026-08-31"
sidebar:
  order: 1
  label: "13.1 Model State, Invariants, and Evidence"
---
## Prerequisites
