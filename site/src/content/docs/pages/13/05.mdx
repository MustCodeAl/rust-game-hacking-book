...
description: "Treat a hook as a versioned, concurrent state transition with instruction, ABI, re-entry, cleanup, and failure invariants—not merely a jump that happens to work once."
chapter: "13.5"
minutes: 52
author: "attilathedud"
date: "2026-08-31"
sidebar:
  order: 5
  label: "13.5 Engineer Robust Hooks and Detours"
---
## Prerequisites
