...
description: "Relay a loopback connection in both directions, preserve framing, and log bounded metadata without changing bytes."
chapter: "6.6"
minutes: 20
author: "attilathedud"
date: "2026-07-30"
sidebar:
  order: 6
  label: "6.6 Build a Transparent Local TCP Proxy"
---
## What a proxy does
...
- a frame the parser cannot decode does not stop forwarding;
