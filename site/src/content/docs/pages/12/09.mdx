...
description: "Understand VM call frames, multiple returns, captured locals, open and closed upvalues, and the host boundary where native functions enter Lua."
chapter: "12.9"
minutes: 40
author: "attilathedud"
date: "2026-08-14"
sidebar:
  order: 9
  label: "12.9 Call Frames, Closures, and Upvalues"
---
