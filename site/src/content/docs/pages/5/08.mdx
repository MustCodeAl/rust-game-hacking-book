...
description: "Reconstruct radar enumeration, filtering, translation, rotation, scale, clipping, and marker semantics as separate testable stages."
chapter: "5.8"
minutes: 23
author: "attilathedud"
date: "2026-07-30"
sidebar:
  order: 8
  label: "5.8 How a Radar Decides What to Show"
---
...
Put the space and unit into variable and field names: `world_metres`, `relative_xy`, or `radar_pixels`. A sign error can look like a wrong pointer, and a degrees-versus-radians error can look like corrupt data. Test known directions first: directly north, east, south, and west of the local player.
...
Keep the height policy as a separate setting from the team/visibility filter, so
changing how height is drawn cannot change which markers appear.
