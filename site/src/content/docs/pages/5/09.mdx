...
description: "Derive and test the complete world-view-clip-NDC-viewport pipeline, including projection conventions, clipping, depth, and stable overlay placement."
chapter: "5.9"
minutes: 44
author: "attilathedud"
date: "2026-07-30"
sidebar:
  order: 9
  label: "5.9 Project 3D Points onto a 2D Overlay"
---
...
![AssaultCube ESP with player name](/assets/images/5/9/cube23.png)
