...
description: "Derive yaw and pitch from vectors, measure true angular error, rank valid targets, and reason about target points, timing, and projectile motion."
chapter: "5.6"
minutes: 35
author: "attilathedud"
date: "2026-07-30"
sidebar:
  order: 6
  label: "5.6 Aim Math and Target Selection"
---
...
1. **Snapshot** — where are the camera and candidates right now?
...
Maths cannot repair a bad snapshot. It can only give the wrong answer more decimal places.
...
Division loses which quadrant the target occupies and
...
![The player layout in a later frame](/assets/images/5/6/cube20.png)
