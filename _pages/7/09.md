...
Those three visible states prove interception and restoration. The full buildable source—including bounded PE parsing and every `unsafe` invariant—is [`iat_hook_lab.rs`](/windows-labs/src/bin/iat_hook_lab.rs).
