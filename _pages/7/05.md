...
{% include quiz.html
  ...
  options="To let the real instruction run once before putting `0xCC` back||To make the process permanently single-threaded||To convert x86 instructions into Rust||To skip the instruction that was replaced"
  answer="0"
