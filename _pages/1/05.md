...
Before opening a debugger or writing Rust, describe the job in three columns:
...
A **syntax error** means the source does not follow Rust's grammar; the compiler
...
Rust groups code at several levels. A **module** organizes names inside code.
A **crate** is one Rust compilation unit. A **package** is the Cargo project
