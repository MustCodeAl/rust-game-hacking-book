...
Write the logic in simple pseudocode before translating it to Rust:

```text
open the authorized target for reading
...
Capture the smallest authorized input—such as a copied byte buffer—then move
...
explains how Rust keeps tests close to the code.
