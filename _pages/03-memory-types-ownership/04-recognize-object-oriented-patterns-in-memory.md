...
Symbols from a debug build are excellent answer keys after you make your first prediction. Compare them with the layout inferred from the version-pinned executable.
...
In a compiled game, treat a pattern name as a **hypothesis**. It helps your
notes communicate a likely role; it does not recreate the original source or
prove the programmer's intention.
