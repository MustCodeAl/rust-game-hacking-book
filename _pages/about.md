...
<div class="course-grid">
  <a class="course-card" href="{{ site.baseurl }}/pages/1/01/"><span>01</span><h3>Start Here</h3><p>Source-grounded questions, computers, memory, game data, and a safe lab.</p></a>
  ...
  <a class="course-card course-card--rust" href="{{ site.baseurl }}/pages/3/01/"><span>03</span><h3>Memory Models & Rust</h3><p>External tools, C++ object layouts, containers, obfuscated values, strings, and DLL contracts.</p></a>
  ...
  <a class="course-card course-card--rust" href="{{ site.baseurl }}/pages/8/01/"><span>08</span><h3>In-Process Tools & Interfaces</h3><p>Rust DLLs, authorized injection, detours, imports, input, menus, and reliable tool design.</p></a>
  ...
  <a class="course-card course-card--rust" href="{{ site.baseurl }}/pages/12/01/"><span>12</span><h3>Lua Automation</h3><p>Tables, Rust host APIs, safe snapshots, state machines, limits, and virtual-machine internals.</p></a>
</div>
