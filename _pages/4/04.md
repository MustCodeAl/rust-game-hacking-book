...
The original 32-bit lab identified three calls. Their absolute addresses came from a run where `flare.exe` loaded at `0x00830000`; use the module-relative offsets in your Rust DLL because the base can move.
...
[`strategy_hooks.rs`](/windows-labs/src/windows_impl/strategy_hooks.rs). Each
